  ...
  return (
    <section className="w-full bg-black py-24 sm:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden text-center flex flex-col items-center">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-0 -translate-y-1/2 w-[500px] h-[500px] bg-purple-dark/30 rounded-full blur-[120px] pointer-events-none"
      />
      <motion.div 
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <p className="font-body text-white/70 font-medium text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
            If you're already running ads, we'll review your account and show you what a properly structured system looks like. If you're starting from scratch, we'll map your full economics and strategy — before you spend a single dollar.
          </p>
        </motion.div>
...
export default MetaAdsFinalCta;
