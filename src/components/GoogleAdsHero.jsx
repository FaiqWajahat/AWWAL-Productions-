    ...
    <section className="relative w-full min-h-screen flex flex-col justify-center bg-background text-foreground px-4 sm:px-6 lg:px-8 pt-32 pb-20 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span className="font-body text-xs sm:text-sm font-bold uppercase tracking-widest text-black">Google Ads Management</span>
        </motion.div>
        ...
        >
          Turn search intent into <br className="hidden lg:block" />
          measurable 
          <span className="relative inline-block text-blue-600 px-2">
            ...
            <motion.span 
              ...
              className="absolute bottom-2 left-0 h-3 bg-blue-500/20 -z-10 skew-x-[-15deg] origin-left"
            />
          </span>
        </motion.h1>
        ...
        >
          We build Google Ads campaigns that capture high-intent buyers exactly when they search.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <span>Book Free Google Ads Audit</span>
          </Link>
