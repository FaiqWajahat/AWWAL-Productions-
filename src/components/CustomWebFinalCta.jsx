  ...
  return (
    <section className="w-full bg-black py-24 sm:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden text-center flex flex-col items-center border-t border-white/10">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 right-0 -translate-y-1/2 w-[500px] h-[500px] bg-purple-dark/20 rounded-full blur-[120px] pointer-events-none"
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          <h2 className="font-heading text-4xl sm:text-5xl lg:text-7xl font-black tracking-tighter text-white leading-[1.05] mb-6 flex flex-wrap justify-center gap-x-3 gap-y-2">
            {"Let's define the system your business needs to".split(" ").map((word, index) => (
              <motion.span 
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <p className="font-body text-white/70 font-medium text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
            Book a free 30-minute scoping session. We'll review your operational bottlenecks, discuss your user flows, and show you exactly what's possible before you commit to anything.
          </p>
        </motion.div>
        ...
        >
          <Link 
            href="/contact"
            className="group relative flex items-center justify-center gap-2 bg-white text-black px-8 sm:px-12 py-5 sm:py-6 rounded-full shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:shadow-[0_0_60px_rgba(255,255,255,0.2)] hover:bg-purple-light transition-all duration-300 w-full sm:w-auto font-body font-bold text-xl"
          >
            Discuss My Custom Project
...
export default CustomWebFinalCta;
