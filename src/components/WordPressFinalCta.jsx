      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          <h2 className="font-heading text-4xl sm:text-5xl lg:text-7xl font-black tracking-tighter text-white leading-[1.05] mb-6 flex flex-wrap justify-center gap-x-3 gap-y-2">
            {"Let's find out exactly what your business needs to".split(" ").map((word, index) => (
              <motion.span 
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <p className="font-body text-white/70 font-medium text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
            If you have an existing website, we'll review it and show you exactly where you're losing customers. If you need a new build, we'll map your strategy before you spend a single dollar.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center gap-2 text-white/60 font-body font-medium text-sm mt-2">
            ...
            <span>Free 30-min call. We'll map exactly what needs to change.</span>
          </div>
        </motion.div>
...
export default WordPressFinalCta;
