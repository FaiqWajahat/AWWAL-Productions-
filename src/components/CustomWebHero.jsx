    ...
    <section className="relative w-full min-h-screen flex flex-col justify-center bg-background text-foreground px-4 sm:px-6 lg:px-8 pt-32 pb-20 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span className="font-body text-xs sm:text-sm font-bold uppercase tracking-widest text-black">Custom Web Development & AI</span>
        </motion.div>
        ...
        >
          Build a system tailored <br className="hidden lg:block" />
        ...
        >
          We engineer fully custom web applications and AI integrations for complex business requirements.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <span>Discuss My Custom Project</span>
          </Link>
